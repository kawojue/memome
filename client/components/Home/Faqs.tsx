    ...
    return (
        <div className={`block`} id='faqs'>
            <div
                ...
                className={`lg:max-w-[1000psx] flex flex-row justify-between  items-center text-[15px] rounded-[2px] p-[17px] md:pl-[10px] md:text-[20px] font-semibold ${isOpen ? 'bg-memo/5' : 'bg-white text-black'
                    }`}
            >
                {faq.question}
                {isOpen ? (
            ...
            <div className={`transition-all duration-300 border-b-2 border-b-[#CECECE] ${isOpen
...
const Faqs: React.FC<FaqsProps> = () => {
    return (
        <section className={`${monst.className} flex flex-col items-center mt-[40px] mx-[32px] md:mx-[66px] md:mt-[55px]`}>
            <div>
                <h2 className={`text-black mx-auto block text-center font-semibold  text-[25px] md:text-[45px] leading-[64px]`}>
